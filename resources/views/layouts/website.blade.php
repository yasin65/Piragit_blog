      ...
      <div class="container-fluid">
        <div class="row align-items-center">
          ...
          <div class="col-4 site-logo">
            <a href="{{route('website.home')}}" class="text-black h2 mb-0">Mini Blog</a>
          </div>
...
@yield('content')
          ...
          <div class="col-md-4">
            ...
            <div>
              ...
              <p>
                ...
                @if($setting->reddt)<a href="{{$setting->reddit}}"target="_blank" ><span class="icon-rss p-2"></span></a>@endif
                @if($setting->email)<a href="{{$setting->email}}"target="_blank" ><span class="icon-envelope p-2"></span></a>@endif
              </p>
            </div>
          </div>
        </div>
  ...
  <script src="{{asset('website')}}/js/jquery.mag{{asset('website')}}/nific-popup.min.js"></script>
